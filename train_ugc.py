...
from model import UGC_BVQA_model,attention_model
...
def main(config):
    ...
    if config.model_name == 'UGC_BVQA_model':
        ...
        # 修改模型
        model = attention_model.resnet50(pretrained=True)
    ...
    videos_dir = 'youtube_ugc/youtube_ugc_image'
    feature_dir = 'youtube_ugc/youtube_ugc_SlowFast_feature'
    datainfo_train = 'data/youtube_ugc_data_1098.mat'
    datainfo_test = 'data/youtube_ugc_data_1098.mat'
    datainfo_all_test = 'data/youtube_ugc_data_1098.mat'
    ...
    trainset = VideoDataset_images_with_motion_features(videos_dir, feature_dir, datainfo_train, transformations_train, 'youtube_ugc', config.crop_size, 'SlowFast')
    testset = VideoDataset_images_with_motion_features(videos_dir, feature_dir, datainfo_test, transformations_test, 'youtube_ugc', config.crop_size, 'SlowFast')
    testset_1080p = VideoDataset_images_with_motion_features(videos_dir, feature_dir, datainfo_all_test, transformations_test, 'youtube_ugc', config.crop_size, 'SlowFast')
