...
def extract_frame(videos_dir, video_name, save_folder,name):
    filename = os.path.join(videos_dir, name)
...
videos_dir = '/home/huyt/vqa-dataset/KoNViD_1k/KoNViD_1k_videos/'
...
# # my code
# data_list = '/home/huyt/vqa-dataset/KoNViD_1k/KoNViD_1k_mos.csv'
# data = pd.read_csv(data_list, sep=',')
# data = np.array(data)
# for group in data:
#     video_names.append(str(int(group[0]))+'.mp4')
...
for i in range(n_video):
    ...
    n=video_name.find('_')
    name=video_name[0:n]+'.mp4'
    extract_frame(videos_dir, video_name, save_folder,name)
