...
class ANN(nn.Module):
    def __init__(self, input_size=3584, reduced_size=128, n_ANNlayers=1, dropout_p=0.5):
        ...
        self.fc = nn.Linear(reduced_size, 3584)  #
        # 3584=2048+1024+512
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000, zero_init_residual=False,
        ...
        self.quality = self.quality_regression(3584+2304, 128,1)
        ...
        self.spatial_relation=TransformerBlock(5888,8, 1024)
    ...
    def _forward_impl(self, x, x_3D_features):
        ...
        # print(x_3D_features_size)
        # x_3D_features=self.motion_CNN(x_3D_features)
        # add GRU
        ...
        # x: batch * frames x (2048 + 1024 + 512 + 2048 + 256)
        x = torch.cat((x, x_3D_features), dim = 1)
        x=self.spatial_relation(x)
        # x: batch * frames x 1
        # quality
        x = self.quality(x)
        # x: batch x frames
