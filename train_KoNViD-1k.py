...
from model import UGC_BVQA_model,attention_model,transformer_model
...
def main(config):
    ...
    if config.model_name == 'UGC_BVQA_model':
        ...
        # model = transformer_model.resnet50(pretrained=True)
    ...
    feature_dir = 'konvid1k_SlowFast_feature'
    datainfo_train = 'data/KoNViD-1k_data_train.mat'
    datainfo_test = 'data/KoNViD-1k_data_test.mat'
    datainfo_all_test = 'data/KoNViD-1k_data.mat'
    ...
    testset_1080p = VideoDataset_images_with_motion_features(videos_dir, feature_dir, datainfo_all_test, transformations_test, 'KoNViD-1k', config.crop_size, 'SlowFast')
